...
impl GeneradorEventos {
    ...
    pub fn generar_eventos(
        ...
        // 3. Eventos normales según perfil
        ...
        // 4. Ordenar por prioridad (y modificador de perfil)
        eventos.sort_by(|a, b| {
    ...
    fn generar_eventos_normales(
        ...
        // Añadir eventos basados en el espacio donde está el protagonista
        // (Por ahora simplificado: siempre añadimos algunos eventos genéricos)

        // Evento de debate (si es diputado)
        ...
        // Evento de café (siempre disponible)
        eventos.push(EventoDisponibleDto {
        ...
        // Evento de crisis de abastecimiento (ocasionally)
        ...
        // Evento de prensa (si hay libertad de imprenta)
        if mundo.jornada_absoluta >= 120 { // Después de noviembre 1810
            eventos.push(EventoDisponibleDto {
                evento_id: "publicar_articulo".to_string(),
                titulo: "Publicar artículo en la prensa".to_string(),
