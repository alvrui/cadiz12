...
/// Oficio o profesion del personaje
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum Oficio {
    Abogado,
...
impl fmt::Display for Oficio {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Oficio::Abogado => write!(f, "abogado"),
            Oficio::Comerciante => write!(f, "comerciante"),
            Oficio::Militar => write!(f, "militar"),
            Oficio::Clerigo => write!(f, "clerigo"),
            Oficio::Funcionario => write!(f, "funcionario"),
            Oficio::Periodista => write!(f, "periodista"),
            Oficio::Medico => write!(f, "medico"),
            Oficio::Profesor => write!(f, "profesor"),
            Oficio::Noble => write!(f, "noble"),
            Oficio::Artesano => write!(f, "artesano"),
        }
    }
}

impl FromStr for Oficio {
    type Err = DomainParseError;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().as_str() {
            "abogado" => Ok(Oficio::Abogado),
            "comerciante" => Ok(Oficio::Comerciante),
            "militar" => Ok(Oficio::Militar),
            "clerigo" => Ok(Oficio::Clerigo),
            "funcionario" => Ok(Oficio::Funcionario),
            "periodista" => Ok(Oficio::Periodista),
            "medico" => Ok(Oficio::Medico),
            "profesor" => Ok(Oficio::Profesor),
            "noble" => Ok(Oficio::Noble),
            "artesano" => Ok(Oficio::Artesano),
            _ => Err(DomainParseError::UnknownValue {
                type_name: "Oficio",
                value: s.to_string(),
            }),
...
// ============================================================================
// ADSCRIPCIONES POLITICAS
// ============================================================================

/// Adscripcion politica del personaje
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
...
impl fmt::Display for Adscripcion {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Adscripcion::Liberal => write!(f, "liberal"),
            Adscripcion::Moderado => write!(f, "moderado"),
            Adscripcion::Conservador => write!(f, "conservador"),
            Adscripcion::Radical => write!(f, "radical"),
            Adscripcion::Independentista => write!(f, "independentista"),
        }
    }
}

impl FromStr for Adscripcion {
    type Err = DomainParseError;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().as_str() {
            "liberal" => Ok(Adscripcion::Liberal),
            "moderado" => Ok(Adscripcion::Moderado),
            "conservador" => Ok(Adscripcion::Conservador),
            "radical" => Ok(Adscripcion::Radical),
            "independentista" => Ok(Adscripcion::Independentista),
            _ => Err(DomainParseError::UnknownValue {
                type_name: "Adscripcion",
                value: s.to_string(),
            }),
        }
    }
...
impl Adscripcion {
    pub fn all() -> &'static [Adscripcion] {
        &[
            Adscripcion::Liberal,
            Adscripcion::Moderado,
            Adscripcion::Conservador,
            Adscripcion::Radical,
            Adscripcion::Independentista,
        ]
    }
}
...
impl fmt::Display for Temperamento {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Temperamento::Apasionado => write!(f, "apasionado"),
            Temperamento::Racional => write!(f, "racional"),
            Temperamento::Pragmatico => write!(f, "pragmatico"),
            Temperamento::Idealista => write!(f, "idealista"),
            Temperamento::Cauteloso => write!(f, "cauteloso"),
            Temperamento::Impulsivo => write!(f, "impulsivo"),
        }
    }
}

impl FromStr for Temperamento {
    type Err = DomainParseError;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().as_str() {
            "apasionado" => Ok(Temperamento::Apasionado),
            "racional" => Ok(Temperamento::Racional),
            "pragmatico" => Ok(Temperamento::Pragmatico),
            "idealista" => Ok(Temperamento::Idealista),
            "cauteloso" => Ok(Temperamento::Cauteloso),
            "impulsivo" => Ok(Temperamento::Impulsivo),
            _ => Err(DomainParseError::UnknownValue {
                type_name: "Temperamento",
                value: s.to_string(),
            }),
        }
    }
...
impl Temperamento {
    pub fn all() -> &'static [Temperamento] {
        &[
            Temperamento::Apasionado,
            Temperamento::Racional,
            Temperamento::Pragmatico,
            Temperamento::Idealista,
            Temperamento::Cauteloso,
